...
- 클러스터 내부에서 동작하는 기능을 외부로 노출하는 것을 서비스라 부름
...
- 인그레스
  - k8s 서비스의 한 종류는 아니고, 복수의 서비스에 대해 목적에 따라 트래픽을 연결하는 도구

### 볼륨 (Volume)

k8s는 클러스터 내에서 이용할 수 있는 저장장치의 추상화된 객체로 볼륨을 정리
